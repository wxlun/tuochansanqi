...
class Host(models.Model):
    ...
    host_alive_check_interval = models.IntegerField('主机存活状态监测间隔',default=30)
...
class Service(models.Model):
    ...
    plugin_name = models.CharField('插件名称',max_length=64,default='n/a')
...
class UserProfile(models.Model):
    user = models.OneToOneField(User,on_delete=models.CASCADE) #注意User不要加引号
